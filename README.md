...
3. Choose your CI: Depending on your preference you can use github actions (recommended).
...
5. Change your CI and cachix names on the README template section and delete
   the rest
